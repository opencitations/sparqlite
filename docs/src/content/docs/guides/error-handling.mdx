...
sparqlite automatically retries on transient errors (5xx responses and connection failures). See [Retry settings](/configuration/retry-settings/) to configure this behavior.
